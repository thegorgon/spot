(function(b) {
    ...
    function f() {
        ...
        function h(m) {
            var l = null; (m) && (m.id) && (c.tinymce) && (l = tinyMCE.get(m.id));
            return l
        }
        function g(l) {
        ...
        function(n, l) {
            ...
            b.fn[l] = function(s) {
                ...
                if (s !== e) {
                    ...
                    var r = "";
                    var q = arguments; (m ? p: p.eq(0)).each(function(u, v) {
                        var t = h(v);
                        $.logger.debug(typeof(l), l, c, h, v);
                        r += t && typeof(t) == "object" ? (m ? t.getContent().replace(/<(?:"[^"]*"|'[^']*'|[^'">])*>/g, "") : t.getContent()) : o.apply(b(v), q)
                    });
                    return r
                }
            }
        });
        b.each(["append", "prepend"],
        function(n, m) {
            var o = j[m] = b.fn[m],
            l = (m === "prepend");
            b.fn[m] = function(q) {
